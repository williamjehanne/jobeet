...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'debug',
  'file' => '/Applications/MAMP/htdocs/sfprojects/jobeet/log/frontend_test.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => '/Applications/MAMP/htdocs/sfprojects/jobeet/cache/frontend/test/i18n',
  'lifetime' => 31556926,
  'prefix' => '/Applications/MAMP/htdocs/sfprojects/jobeet/apps/frontend/i18n',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('symfony'),
  ...
  'session_path' => '/Applications/MAMP/htdocs/sfprojects/jobeet/cache/frontend/test/test/sessions',
))));
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/Applications/MAMP/htdocs/sfprojects/jobeet/cache/frontend/test/template',
  'lifetime' => 86400,
  'prefix' => '/Applications/MAMP/htdocs/sfprojects/jobeet/apps/frontend/template',
)));
